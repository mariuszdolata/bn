...
//					
//				}
//				Integer nextInt = gen.nextInt(Integer.parseInt(this.getProperties().getProperty("randDelayMax"))+Integer.parseInt(this.getProperties().getProperty("delay")));
//				logger.info("Opoznienie miedzy kolejnymi profilami wynioslo="+nextInt);
